...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center  header-transparent ">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="index.html">HMSI UNAND</a></h1>
        ...
        <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <div class="carousel-container">
                    ...
                    <p class="animate__animated fanimate__adeInUp">HMSI adalah Himpunan Mahasiswa Sistem Informasi yang berada pada jurusan Sistem Informasi yang berfungsi sebagai wadah untuk menyalurkan aspirasi, media komunikasi dan informasi, serta pembelajaran organisasi untuk pengembangan diri bagi anggotanya.</p>
            ...
            <div class="carousel-item">
                <div class="carousel-container">
                    <h2 class="animate__animated animate__fadeInDown">Open Recruitment 2021</h2>
                    <p class="animate__animated animate__fadeInUp">HMSI telah membuka open recruitment bagi seluruh mahasiswa Sistem Informasi Unand Angkatan 2018 dan 2019 pada tanggal 31 Oktober - 6 November 2021. Ayo, Daftarkan dirimu!</p>
                    <a href="#recruitment" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
                </div>
            </div>
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row content" data-aos="fade-up">
                    <div class="col-lg-6">
                        ...
                        <ul>
                            <li><i class="ri-check-double-line"></i>Mempererat ikatan kekeluargaan internal & eksternal HMSI.</li>
                            <li><i class="ri-check-double-line"></i>Meningkatkan akhlak mulia dan sikap profesional dalam menjalankan kepengurusan HMSI.</li>
                            <li><i class="ri-check-double-line"></i>Mengembangkan kemampuan akademik dan non-akademik anggota.</li>
                            <li><i class="ri-check-double-line"></i>Meningkatkan prestasi anggota HMSI.</li>
                        </ul>
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0">
                        <p>
                            Visi :
                            "Menjadikan HMSI sebagai himpunan yang memiliki pribadi-pribadi yang unggul dan profesional dengan berlandaskan asas kekeluargaan dan keagamaan."
                        </p>
                    </div>
                </div>
        ...
        <!-- ======= Section Recruitment ======= -->
        <section id="recruitment" class="faq">
            <div class="container">

                <div class="section-title" data-aos="zoom-out">
                    <h2>Open Recruitment</h2>
                    <p>Pengurus HMSI 2021/2022</p>
                </div>

                <ul class="faq-list">
                    <li>
                        <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">Tahap Pendaftaran<i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                [ 1 Nov - 5 Nov 2021 ] Peserta dapat melakukan pendaftaran dengan mengklik tombol pendaftaran dibawah
                            </p>
                        </div>
                    </li>

                    <li>
                        <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">Tahap Wawancara <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
                        <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                [ 6 Nov - 7 Nov 2021 ] Peserta dapat melakukan tahap wawancara dengan memilih jadwal yang telah disediakan
                            </p>
                        </div>
                    </li>
