            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span>Unand</span>
                        </a></div>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-bar-chart-alt"></i> Charts <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="{{asset('focus/chart-flot.html')}}">Flot</a></li>
                            <li><a href="{{asset('focus/chart-morris.html')}}">Morris</a></li>
                            <li><a href="{{asset('focus/chartjs.html')}}">Chartjs</a></li>
                            <li><a href="{{asset('focus/chartist.html')}}">Chartist</a></li>
                            <li><a href="{{asset('focus/chart-peity.html')}}">Peity</a></li>
                            <li><a href="{{asset('focus/chart-sparkline.html')}}">Sparkle</a></li>
                            <li><a href="{{asset('focus/chart-knob.html')}}">Knob</a></li>
                        </ul>
                    </li>
                    <li><a href="{{asset('focus/app-event-calender.html')}}"><i class="ti-calendar"></i> Calender </a></li>
                    <li><a href="{{asset('focus/app-email.html')}}"><i class="ti-email"></i> Email</a></li>
                    <li><a href="{{asset('focus/app-profile.html')}}"><i class="ti-user"></i> Profile</a></li>
                    <li><a href="{{asset('focus/app-widget-card.html')}}"><i class="ti-layout-grid2-alt"></i> Widget</a></li>
                    <li class="{{asset('focus/label')}}">Features</li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i> UI Elements <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="{{asset('focus/ui-typography.html')}}">Typography</a></li>
                            <li><a href="{{asset('focus/ui-alerts.html')}}">Alerts</a></li>

                            <li><a href="{{asset('focus/ui-button.html')}}">Button</a></li>
                            <li><a href="{{asset('focus/ui-dropdown.html')}}">Dropdown</a></li>

                            <li><a href="{{asset('focus/ui-list-group.html')}}">List Group</a></li>

                            <li><a href="{{asset('focus/ui-progressbar.html')}}">Progressbar</a></li>
                            <li><a href="{{asset('focus/ui-tab.html')}}">Tab</a></li>

                        </ul>
                    </li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-panel"></i> Components <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="{{asset('focus/uc-calendar.html')}}">Calendar</a></li>
                            <li><a href="{{asset('focus/uc-carousel.html')}}">Carousel</a></li>
                            <li><a href="{{asset('focus/uc-weather.html')}}">Weather</a></li>
                            <li><a href="{{asset('focus/uc-datamap.html')}}">Datamap</a></li>
                            <li><a href="{{asset('focus/uc-todo-list.html')}}">To do</a></li>
                            <li><a href="{{asset('focus/uc-scrollable.html')}}">Scrollable</a></li>
                            <li><a href="{{asset('focus/uc-sweetalert.html')}}">Sweet Alert</a></li>
                            <li><a href="{{asset('focus/uc-toastr.html')}}">Toastr</a></li>
                            <li><a href="{{asset('focus/uc-range-slider-basic.html')}}">Basic Range Slider</a></li>
                            <li><a href="{{asset('focus/uc-range-slider-advance.html')}}">Advance Range Slider</a></li>
                            <li><a href="{{asset('focus/uc-nestable.html')}}">Nestable</a></li>

                            <li><a href="{{asset('focus/uc-rating-bar-rating.html')}}">Bar Rating</a></li>
                            <li><a href="{{asset('focus/uc-rating-jRate.html')}}">jRate</a></li>
                        </ul>
                    </li>
